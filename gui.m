...
if isequal(cout,1)
   ...
   set(handles.text6,'String','Normal :'); 
   set(handles.text1,'String','No Microplastics Found');
   
elseif isequal(cout,2)
    
  set(handles.text6,'String','Plastic Type:'); 
  set(handles.text1,'String','LEPD Plastics Found');
   
elseif isequal(cout,3)
    
  set(handles.text6,'String','Plastic Type:'); 
  set(handles.text1,'String','PE Plastics Found');
elseif isequal(cout,4)
    
  set(handles.text6,'String','Plastic Type:'); 
  set(handles.text1,'String','PHA Found');
elseif isequal(cout,5)
    
  set(handles.text6,'String','Plastic Type:'); 
  set(handles.text1,'String','PHA Plastics Found');
else
...
% Read the image file
imageName = 'SS.png'; % Replace with your image file name and format (e.g., 'image.png')
I = imread(imageName);
figure;
% Display the image
imshow(I);
...
elseif result ==2
   ...
   axes(handles.axes1); 
   imshow(inp); title('LEPD - Plastics');
   hold on;
